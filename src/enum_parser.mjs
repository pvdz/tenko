...
const VERSION_JSON_SUPERSET = 10; // ES2019 (unescaped <LS>/<PS> in string literals)
const VERSION_DYNAMIC_IMPORT = 11; // ES2020
const VERSION_EXPORT_STAR_AS = 11; // ES2020
const VERSION_IMPORT_META = 11; // ES2020
const VERSION_BIGINT = 11; // ES2020
const VERSION_OPTIONAL_CHAINING = 11; // ES2020
const VERSION_NULLISH_COALESCING = 11; // ES2020
const VERSION_LOGICAL_ASSIGNMENT = 12; // ES2021 (&&=, ||=, ??=)
const VERSION_NUMERIC_SEPARATOR = 12; // ES2021 (`1_000`)
const VERSION_TOPLEVEL_AWAIT = 13; // ES2022
const VERSION_DUP_PROTO_MAIN = 13; // ES2022 moved the duplicate __proto__ early error from Annex B.3.1 into the main body (13.2.5.1)
...
let BINDING_TYPE_USING = DEVONLY() ? {BINDING_TYPE_USING: 1} : 11;
let BINDING_TYPE_AWAIT_USING = DEVONLY() ? {BINDING_TYPE_AWAIT_USING: 1} : 12;
