...
const BINDING_TYPE_LET = DEVONLY() ? {BINDING_TYPE_LET: 1} : 3;
const BINDING_TYPE_CONST = DEVONLY() ? {BINDING_TYPE_CONST: 1} : 4;
const BINDING_TYPE_CLASS = DEVONLY() ? {BINDING_TYPE_CLASS: 1} : 5;
const BINDING_TYPE_FUNC_VAR = DEVONLY() ? {BINDING_TYPE_FUNC_VAR: 1} : 7;
const BINDING_TYPE_FUNC_LEX = DEVONLY() ? {BINDING_TYPE_FUNC_LEX: 1} : 8;
const BINDING_TYPE_FUNC_STMT = DEVONLY() ? {BINDING_TYPE_FUNC_STMT: 1} : 9; // A func decl inside a block or switch (for webcompat mode)
const BINDING_TYPE_CATCH_IDENT = DEVONLY() ? {BINDING_TYPE_CATCH_IDENT: 1} : 10;
const BINDING_TYPE_CATCH_OTHER = DEVONLY() ? {BINDING_TYPE_CATCH_OTHER: 1} : 11;
...
const NO_DUPE_PARAMS = DEVONLY() ? {NO_DUPE_PARAMS: 1} : undefined;
...
const SCOPE_LAYER_TRY = DEVONLY() ? {SCOPE_LAYER_TRY: 1} : 4;
