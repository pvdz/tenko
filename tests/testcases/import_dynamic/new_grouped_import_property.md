...
- Path: tests/testcases/import_dynamic/new_grouped_import_property.md

> :: import dynamic
>
> ::> new grouped import property
>
> new (import(x)).foo - property access on grouped import in new
