...
- Path: tests/testcases/group_or_arrow/spread_keyword_literal/obj_prop_false.md

> :: group or arrow : spread keyword literal
>
> ::> obj prop false
>
> the same as an object literal value
...
tokens (12x):
       ...
       PUNC_BRACKET_OPEN PUNC_DOT_DOT_DOT ID_false PUNC_BRACKET_CLOSE
