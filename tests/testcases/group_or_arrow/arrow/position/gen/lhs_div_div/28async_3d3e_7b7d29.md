...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/lhs_div_div/28async_3d3e_7b7d29.md
...
tokens (12x):
       ...
       PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE PUNC_DIV IDENT PUNC_DIV IDENT
       ASI
`````
