...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/rhs_div_asi/28async_3d3e_7b7d29.md
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          ...
          loc:{start:{line:2,column:3},end:{line:2,column:14},source:''},
          params: [
            {
              type: 'Identifier',
...
tokens (10x):
       IDENT PUNC_DIV PUNC_PAREN_OPEN ID_async PUNC_EQ_GT
