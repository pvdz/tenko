...
- Path: tests/testcases/for_statement/for_init_sequence_no_in/ok_in_arr.md

> :: for statement : for init sequence no in
>
> ::> ok in arr
>
> an `in` inside an array literal is unaffected
...
tokens (15x):
       ...
       PUNC_COMMA PUNC_BRACKET_OPEN IDENT ID_in IDENT
