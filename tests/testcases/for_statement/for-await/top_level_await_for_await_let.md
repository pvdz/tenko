...
- Path: tests/testcases/for_statement/for-await/top_level_await_for_await_let.md

> :: for statement : for-await
>
> ::> top level await for await let
>
> for await with let binding at module top level (top-level await)
...
tokens (19x):
       ID_for ID_await PUNC_PAREN_OPEN ID_let IDENT ID_of
