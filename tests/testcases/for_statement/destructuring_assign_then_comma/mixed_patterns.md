...
- Path: tests/testcases/for_statement/destructuring_assign_then_comma/mixed_patterns.md

> :: for statement : destructuring assign then comma
>
> ::> mixed patterns
>
> an array then an object pattern
...
tokens (16x):
       ...
       PUNC_EQ IDENT PUNC_COMMA PUNC_CURLY_OPEN PUNC_CURLY_CLOSE
