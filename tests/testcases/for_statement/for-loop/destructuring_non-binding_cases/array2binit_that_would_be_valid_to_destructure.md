...
- Path: tests/testcases/for_statement/for-loop/destructuring_non-binding_cases/array2binit_that_would_be_valid_to_destructure.md

> :: for statement : for-loop : destructuring non-binding cases
>
> ::> array2binit that would be valid to destructure
