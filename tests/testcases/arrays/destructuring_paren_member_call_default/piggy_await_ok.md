...
- Path: tests/testcases/arrays/destructuring_paren_member_call_default/piggy_await_ok.md

> :: arrays : destructuring paren member call default
>
> ::> piggy await ok
>
> an await in the default of such an element
...
tokens (19x):
       ...
       PUNC_BRACKET_OPEN IDENT PUNC_BRACKET_CLOSE PUNC_EQ ID_await
