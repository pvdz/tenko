...
- Path: tests/testcases/arrays/destructuring_paren_member_call_default/ok_obj_pattern.md

> :: arrays : destructuring paren member call default
>
> ::> ok obj pattern
>
> the object pattern equivalent
...
tokens (20x):
       ...
       IDENT PUNC_BRACKET_CLOSE PUNC_EQ IDENT PUNC_PAREN_OPEN
       PUNC_PAREN_CLOSE PUNC_CURLY_CLOSE PUNC_EQ IDENT
