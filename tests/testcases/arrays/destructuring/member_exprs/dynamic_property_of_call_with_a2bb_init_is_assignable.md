...
- Path: tests/testcases/arrays/destructuring/member_exprs/dynamic_property_of_call_with_a2bb_init_is_assignable.md

> :: arrays : destructuring : member exprs
>
> ::> dynamic property of call with a2bb init is assignable
