...
- Path: tests/testcases/using/yield_binding_non_generator_pass.md

> :: using
>
> ::> yield binding non generator pass
>
> non-generator: yield can be an identifier binding
...
tokens (14x):
       ...
       PUNC_CURLY_OPEN ID_using ID_yield PUNC_EQ IDENT PUNC_PAREN_OPEN
