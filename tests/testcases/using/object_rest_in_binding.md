...
- Path: tests/testcases/using/object_rest_in_binding.md

> :: using
>
> ::> object rest in binding
>
> object rest in binding pattern
...
tokens (11x):
       ID_using PUNC_CURLY_OPEN IDENT PUNC_COMMA PUNC_DOT_DOT_DOT
