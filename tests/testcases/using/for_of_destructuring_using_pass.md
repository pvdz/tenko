...
- Path: tests/testcases/using/for_of_destructuring_using_pass.md

> :: using
>
> ::> for of destructuring using pass
>
> destructuring using in for-of
...
tokens (14x):
       ID_for PUNC_PAREN_OPEN ID_using PUNC_CURLY_OPEN IDENT
