...
- Path: tests/testcases/using/await_using_computed_access_fallback.md

> :: using
>
> ::> await using computed access fallback
>
> await using[0] falls back to member access (no destructuring with using)
...
tokens (14x):
       ...
       PUNC_CURLY_OPEN ID_await ID_using PUNC_BRACKET_OPEN NUMBER_DEC
