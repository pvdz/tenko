...
- Path: tests/testcases/using/await_using_static_block/plain_using_for_of.md

> :: using : await using static block
>
> ::> plain using for of
>
> the same in a for-of header
...
`````js
class C { static { for (using x of y); } }
`````
...
tokens (16x):
       ...
       PUNC_PAREN_OPEN ID_using IDENT ID_of IDENT PUNC_PAREN_CLOSE
