...
- Path: tests/testcases/using/await_using_call_fallback.md

> :: using
>
> ::> await using call fallback
>
> `await using();` should parse as `await (using())` not as a declaration
...
tokens (13x):
       ...
       PUNC_CURLY_OPEN ID_await ID_using PUNC_PAREN_OPEN
