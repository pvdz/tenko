...
- Path: tests/testcases/using/export_const_using_pass.md

> :: using
>
> ::> export const using pass
>
> Module goal: exported const named using
...
tokens (7x):
       ID_export ID_const ID_using PUNC_EQ NUMBER_DEC PUNC_SEMI
`````
