...
- Path: tests/testcases/using/await_binding_non_async_pass.md

> :: using
>
> ::> await binding non async pass
>
> Script goal non-async: await can be an identifier binding
...
tokens (14x):
       ...
       PUNC_CURLY_OPEN ID_using ID_await PUNC_EQ IDENT PUNC_PAREN_OPEN
