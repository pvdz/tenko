...
- Path: tests/testcases/using/using_generator_expression_init.md

> :: using
>
> ::> using generator expression init
>
> generator expression as await-using initializer
...
`````js
async function f(){ await using x = function*() {}; }
`````
