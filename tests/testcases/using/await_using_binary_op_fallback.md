...
- Path: tests/testcases/using/await_using_binary_op_fallback.md

> :: using
>
> ::> await using binary op fallback
>
> `await using + 1;` should parse as `(await using) + 1` not as a declaration
...
tokens (13x):
       ...
       PUNC_CURLY_OPEN ID_await ID_using PUNC_PLUS NUMBER_DEC
