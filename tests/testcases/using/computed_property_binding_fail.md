...
- Path: tests/testcases/using/computed_property_binding_fail.md

> :: using
>
> ::> computed property binding fail
>
> computed property names not allowed in binding patterns
...
tokens (12x):
       ID_using PUNC_CURLY_OPEN PUNC_BRACKET_OPEN STRING_DOUBLE
