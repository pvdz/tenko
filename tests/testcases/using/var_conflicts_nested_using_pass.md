...
- Path: tests/testcases/using/var_conflicts_nested_using_pass.md

> :: using
>
> ::> var conflicts nested using pass
>
> var in outer scope does not conflict with using in nested block
