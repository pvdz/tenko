...
- Path: tests/testcases/using/for_using_as_expression_pass.md

> :: using
>
> ::> for using as expression pass
>
> for (using x = ...) is a C-style for with using declaration
...
tokens (12x):
       ID_for PUNC_PAREN_OPEN ID_using IDENT PUNC_EQ ID_null PUNC_SEMI
