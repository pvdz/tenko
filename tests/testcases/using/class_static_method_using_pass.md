...
- Path: tests/testcases/using/class_static_method_using_pass.md

> :: using
>
> ::> class static method using pass
>
> using as static class method name
...
tokens (11x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static ID_using
