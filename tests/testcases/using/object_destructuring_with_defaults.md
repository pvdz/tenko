...
- Path: tests/testcases/using/object_destructuring_with_defaults.md
...
tokens (16x):
       ID_using PUNC_CURLY_OPEN IDENT PUNC_EQ NUMBER_DEC PUNC_COMMA
       IDENT PUNC_COLON IDENT PUNC_EQ NUMBER_DEC PUNC_CURLY_CLOSE
