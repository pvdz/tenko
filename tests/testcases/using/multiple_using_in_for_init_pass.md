...
- Path: tests/testcases/using/multiple_using_in_for_init_pass.md

> :: using
>
> ::> multiple using in for init pass
>
> multiple using declarators in for-init
