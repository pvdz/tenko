...
- Path: tests/testcases/using/using_newline_not_declaration_pass.md

> :: using
>
> ::> using newline not declaration pass
>
> `using` followed by a newline should NOT be a declaration, just an expression
...
tokens (7x):
       ID_using ASI IDENT PUNC_EQ NUMBER_DEC PUNC_SEMI
`````
