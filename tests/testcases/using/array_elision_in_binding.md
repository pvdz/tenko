...
- Path: tests/testcases/using/array_elision_in_binding.md

> :: using
>
> ::> array elision in binding
>
> array elision in binding pattern
...
tokens (11x):
       ID_using PUNC_BRACKET_OPEN IDENT PUNC_COMMA PUNC_COMMA IDENT
