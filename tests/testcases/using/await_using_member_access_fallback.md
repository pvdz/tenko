...
- Path: tests/testcases/using/await_using_member_access_fallback.md

> :: using
>
> ::> await using member access fallback
>
> `await using.foo;` should parse as `await (using.foo)` not as a declaration
...
tokens (13x):
       ...
       PUNC_CURLY_OPEN ID_await ID_using PUNC_DOT IDENT PUNC_SEMI
       PUNC_CURLY_CLOSE
`````
