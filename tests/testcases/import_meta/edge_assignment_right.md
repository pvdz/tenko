...
- Path: tests/testcases/import_meta/edge_assignment_right.md

> :: import meta
>
> ::> edge assignment right
>
> import.meta edge: x = (import.meta) assignment right
...
tokens (12x):
       ID_let IDENT PUNC_SEMI IDENT PUNC_EQ PUNC_PAREN_OPEN ID_import
