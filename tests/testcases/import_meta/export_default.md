...
- Path: tests/testcases/import_meta/export_default.md

> :: import meta
>
> ::> export default
>
> import.meta : export default import.meta
...
tokens (7x):
       ID_export ID_default ID_import PUNC_DOT IDENT ASI
`````
