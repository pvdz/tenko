...
- Path: tests/testcases/import_meta/static_block.md

> :: import meta
>
> ::> static block
>
> import.meta : in class static block
...
tokens (12x):
       ...
       ID_import PUNC_DOT IDENT PUNC_SEMI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
