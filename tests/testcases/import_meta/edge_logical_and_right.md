...
- Path: tests/testcases/import_meta/edge_logical_and_right.md

> :: import meta
>
> ::> edge logical and right
>
> import.meta edge: 1 && (import.meta) logical and right
...
tokens (9x):
       NUMBER_DEC PUNC_AND_AND PUNC_PAREN_OPEN ID_import PUNC_DOT
