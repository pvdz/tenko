...
- Path: tests/testcases/export_declaration/dup_names_from_clause/ok_distinct_clauses.md
...
`````js
export {a as b} from "x"; export {c as d} from "y"
`````
...
start@1:0, error@1:0
╔══╦════════════════
 1 ║ export {a as b} from "x"; export {c as d} from "y"
   ║ ^^^^^^------- error
╚══╩════════════════
