...
- Path: tests/testcases/await/arrow_piggy/gen/test/287ba3a_b_3d_await7d29_3d3e_x.md

> :: await : arrow piggy : gen : test
>
> ::> 287ba3a b 3d await7d29 3d3e x
...
tokens (13x):
       ...
       ID_await PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE PUNC_EQ_GT IDENT ASI
`````
