...
- Path: tests/testcases/objects/destructuring/call_tail_value/object_value_call_expr.md

> :: objects : destructuring : call tail value
>
> ::> object value call expr
>
> same, for an object literal value
...
tokens (16x):
       ...
       PUNC_PAREN_OPEN IDENT PUNC_PAREN_CLOSE PUNC_CURLY_CLOSE
