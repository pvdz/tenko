...
- Path: tests/testcases/objects/destructuring/call_tail_value/array_value_member_after.md

> :: objects : destructuring : call tail value
>
> ::> array value member after
>
> a member tail after the call makes it a valid target again
