...
- Path: tests/testcases/objects/destructuring/call_tail_value/array_value_computed_after.md

> :: objects : destructuring : call tail value
>
> ::> array value computed after
>
> a computed tail after the call makes it a valid target again
