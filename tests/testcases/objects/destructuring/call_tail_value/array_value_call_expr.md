...
- Path: tests/testcases/objects/destructuring/call_tail_value/array_value_call_expr.md

> :: objects : destructuring : call tail value
>
> ::> array value call expr
>
> a call tail value is fine in a plain object literal
