...
- Path: tests/testcases/objects/destructuring/call_tail_value/array_value_member_tail.md

> :: objects : destructuring : call tail value
>
> ::> array value member tail
>
> a plain member tail is a valid destructuring target
