...
- Path: tests/testcases/objects/duplicate_keys/proto_versions/dup_proto_assign_exempt_es13.md

> :: objects : duplicate keys : proto versions
>
> ::> dup proto assign exempt es13
>
> duplicate proto exempt when object refines to assignment pattern
