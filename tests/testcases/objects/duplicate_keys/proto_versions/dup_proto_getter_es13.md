...
- Path: tests/testcases/objects/duplicate_keys/proto_versions/dup_proto_getter_es13.md

> :: objects : duplicate keys : proto versions
>
> ::> dup proto getter es13
>
> accessor proto does not count (MethodDefinition production, not colon form)
