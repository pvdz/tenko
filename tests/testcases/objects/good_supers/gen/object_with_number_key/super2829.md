...
- Path: tests/testcases/objects/good_supers/gen/object_with_number_key/super2829.md
                ...
                body: [
                  {
                    ...
                    loc:{start:{line:3,column:4},end:{line:3,column:20},source:''},
                    expression: {
                      type: 'ObjectExpression',
                      loc:{start:{line:3,column:5},end:{line:3,column:19},source:''},
                      properties: [
                        {
                          type: 'Property',
                          loc:{start:{line:3,column:6},end:{line:3,column:18},source:''},
                          key: {
                            type: 'Literal',
                          ...
                          value: {
                            type: 'CallExpression',
                            loc:{start:{line:3,column:11},end:{line:3,column:18},source:''},
                            optional: false,
                            callee: {
                              type: 'Super',
...
````js
class x extends (y) {constructor(){({123:super()});};}
````
