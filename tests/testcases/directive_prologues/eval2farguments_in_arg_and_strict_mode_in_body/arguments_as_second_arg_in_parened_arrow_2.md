...
- Path: tests/testcases/directive_prologues/eval2farguments_in_arg_and_strict_mode_in_body/arguments_as_second_arg_in_parened_arrow_2.md
...
╔══╦═════════════════
 1 ║ function f(a, arguments) { "use strict"; }
   ║                                          ^------- error
╚══╩═════════════════
