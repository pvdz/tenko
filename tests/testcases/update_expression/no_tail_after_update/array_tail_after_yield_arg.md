...
- Path: tests/testcases/update_expression/no_tail_after_update/array_tail_after_yield_arg.md

> :: update expression : no tail after update
>
> ::> array tail after yield arg
>
> the array around a yield expression may take a tail
