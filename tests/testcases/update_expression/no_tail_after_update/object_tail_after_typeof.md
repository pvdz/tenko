...
- Path: tests/testcases/update_expression/no_tail_after_update/object_tail_after_typeof.md

> :: update expression : no tail after update
>
> ::> object tail after typeof
>
> the object around a unary expression may still take a tail
...
tokens (13x):
       ...
       IDENT PUNC_MIN_MIN PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE PUNC_DOT
       IDENT ASI
`````
