...
- Path: tests/testcases/update_expression/no_tail_after_update/await_arg_array_tail.md

> :: update expression : no tail after update
>
> ::> await arg array tail
>
> and the same for the array around it
...
`````js
async function g(){ [await delete a++].b }
`````
...
tokens (17x):
       ...
       PUNC_CURLY_OPEN PUNC_BRACKET_OPEN ID_await ID_delete IDENT
