...
- Path: tests/testcases/update_expression/no_tail_after_update/array_tail_yield_update.md

> :: update expression : no tail after update
>
> ::> array tail yield update
>
> the same for a yield with an update argument
...
tokens (16x):
       ...
       PUNC_CURLY_OPEN PUNC_BRACKET_OPEN ID_yield IDENT PUNC_PLUS_PLUS
