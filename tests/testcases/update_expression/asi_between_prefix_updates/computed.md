...
- Path: tests/testcases/update_expression/asi_between_prefix_updates/computed.md

> :: update expression : asi between prefix updates
>
> ::> computed
>
> the same with computed member arguments
...
tokens (13x):
       PUNC_PLUS_PLUS IDENT PUNC_BRACKET_OPEN IDENT PUNC_BRACKET_CLOSE
       ASI PUNC_PLUS_PLUS IDENT PUNC_BRACKET_OPEN IDENT
