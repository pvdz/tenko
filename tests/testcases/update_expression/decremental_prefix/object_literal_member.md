...
- Path: tests/testcases/update_expression/decremental_prefix/object_literal_member.md

> :: update expression : decremental prefix
>
> ::> object literal member
>
> prefix decrement on object literal with arrow then ._
...
tokens (13x):
       PUNC_MIN_MIN PUNC_CURLY_OPEN IDENT PUNC_COLON PUNC_PAREN_OPEN
       PUNC_PAREN_CLOSE PUNC_EQ_GT ID_null PUNC_CURLY_CLOSE PUNC_DOT
       IDENT ASI
`````
