...
- Path: tests/testcases/strict_mode/directive_headers/ident_3d_5binterface5d/obj_method/assigned_to_in_param_default_w_directive.md
...
╔══╦═════════════════
 1 ║ o = {foo(x=interface=y){ "use strict"; }}
   ║                                        ^------- error
╚══╩═════════════════
