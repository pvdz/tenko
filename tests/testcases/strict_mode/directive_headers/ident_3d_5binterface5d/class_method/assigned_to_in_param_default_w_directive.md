...
- Path: tests/testcases/strict_mode/directive_headers/ident_3d_5binterface5d/class_method/assigned_to_in_param_default_w_directive.md
...
╔══╦═════════════════
 1 ║ class c {foo(x=interface=y){ "use strict"; }}
   ║                ^^^^^^^^^------- error
╚══╩═════════════════
