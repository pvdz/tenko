...
- Path: tests/testcases/strict_mode/directive_headers/ident_3d_5bpackage5d/function_expr/assigned_to_in_param_default_w_directive.md
...
╔══╦═════════════════
 1 ║ f = function f(x=package=10){ "use strict"; }
   ║                                             ^------- error
╚══╩═════════════════
