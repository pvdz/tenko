...
- Path: tests/testcases/strict_mode/directive_headers/ident_3d_5barguments5d/function_expr/as_param_name_w_directive.md
...
╔══╦═════════════════
 1 ║ f = function f(arguments){ "use strict"; }
   ║                                          ^------- error
╚══╩═════════════════
