...
- Path: tests/testcases/strict_mode/directive_headers/ident_3d_5bpublic5d/function_expr/assigned_to_in_param_default_w_directive.md
...
╔══╦═════════════════
 1 ║ f = function f(x=public=10){ "use strict"; }
   ║                                            ^------- error
╚══╩═════════════════
