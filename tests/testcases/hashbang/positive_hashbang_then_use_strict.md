...
- Path: tests/testcases/hashbang/positive_hashbang_then_use_strict.md

> :: hashbang
>
> ::> positive hashbang then use strict
>
> Hashbang then DirectivePrologue: "use strict"; must still be recognized in global. Script is strict.
>
> 
...
tokens (5x):
       STRING_DOUBLE PUNC_SEMI NUMBER_DEC PUNC_SEMI
`````
