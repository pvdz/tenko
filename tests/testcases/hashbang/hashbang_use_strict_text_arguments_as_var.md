...
- Path: tests/testcases/hashbang/hashbang_use_strict_text_arguments_as_var.md

> :: hashbang
>
> ::> hashbang use strict text arguments as var
>
> Hashbang with use strict text is a comment so arguments as var name is legal in sloppy
...
tokens (6x):
       ID_var ID_arguments PUNC_EQ NUMBER_DEC ASI
`````
