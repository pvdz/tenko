...
- Path: tests/testcases/bindings/catch/shadowing/es9/gen/Binding_in_for-of-header_shadowing_catch_var/const.md

> :: bindings : catch : shadowing : es9 : gen : Binding in for-of-header shadowing catch var
>
> ::> const
