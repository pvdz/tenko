...
- Path: tests/testcases/bindings/catch/shadowing/es10/gen/Binding_in_for-header_shadowing_catch_var/const.md

> :: bindings : catch : shadowing : es10 : gen : Binding in for-header shadowing catch var
>
> ::> const
