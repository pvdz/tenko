...
- Path: tests/testcases/bindings/methods/classes/dupe_args_with_local_bindings/simple_arg_as_own_func_name.md

> :: bindings : methods : classes : dupe args with local bindings
>
