...
`````
throws: Lexer error!
    Regex: Encountered incorrect range (left>right, 97 > 8, 0x61 > 0x8) which is illegal with u-flag or v-flag; Encountered incorrect range (left>right, 97 > 8, 0x61 > 0x8) when parsing as if without u-flag or v-flag
