...
`````
throws: Lexer error!
    Regex: The `\c` escape is only legal in a char class without u-flag or v-flag and in webcompat mode; Encountered incorrect range (left>right, 97 > 92, 0x61 > 0x5c) when parsing as if without u-flag or v-flag
