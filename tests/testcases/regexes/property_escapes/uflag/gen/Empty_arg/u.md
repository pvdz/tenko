...
`````
throws: Lexer error!
    Regex: The escaped lone property name `` is not valid (does not appear in "table 55" nor "table 56"); Regex contained syntax that is invalid with the u-flag but the u-flag was present
