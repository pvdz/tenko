...
- Path: tests/testcases/regexes/property_escapes/ranges/gen/Left_of_range_z/u.md
...
`````
throws: Lexer error!
    Regex: Character class escapes `\d \D \s \S \w \W \p \P` not allowed in "ranges" when u-flag or v-flag is set; Encountered incorrect range (left>right, 125 > 122, 0x7d > 0x7a) when parsing as if without u-flag or v-flag
