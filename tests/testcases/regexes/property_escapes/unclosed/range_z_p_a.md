...
`````
throws: Lexer error!
    Regex: Property escape `\p` must start with a curly bracket; Encountered incorrect range (left>right, 122 > 112, 0x7a > 0x70) when parsing as if without u-flag or v-flag
