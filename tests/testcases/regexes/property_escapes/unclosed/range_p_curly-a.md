...
`````
throws: Lexer error!
    Regex: Property escape `\p` contained illegal character `-`; Encountered incorrect range (left>right, 123 > 122, 0x7b > 0x7a) when parsing as if without u-flag or v-flag
