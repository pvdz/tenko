...
`````
throws: Lexer error!
    Regex: Property escape `\p` contained illegal character `-`; Encountered incorrect range (left>right, 61 > 60, 0x3d > 0x3c) when parsing as if without u-flag or v-flag
