...
> ::> idrest es6 unicode
>
> `\u{1D7D0}` is a valid id_continue. Since ES2020 (tc39/ecma262#1869) double-quad surrogate pair escapes are valid in group names even without u-flag.
  ...
  body: [
    {
      ...
      expression: {
        ...
        raw: '/(?<abc\\u{1D7D0}def>foo\\k<abc\\u{1D7D0}def>)/'
      }
    }
  ]
}
