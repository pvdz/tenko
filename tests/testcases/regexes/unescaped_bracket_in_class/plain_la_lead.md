...
- Path: tests/testcases/regexes/unescaped_bracket_in_class/plain_la_lead.md

> :: regexes : unescaped bracket in class
>
> ::> plain la lead
>
> the same with an atom before the bracket is a QuantifiableAssertion under annexB
