...
- Path: tests/testcases/regexes/props_of_strings_needs_flag/uflag_rgi_emoji_flag_sequence.md

> :: regexes : props of strings needs flag
>
> ::> uflag rgi emoji flag sequence
>
...
`````js
x = /a\p{RGI_Emoji_Flag_Sequence}/u
`````
...
start@1:0, error@1:4
╔══╦════════════════
 1 ║ x = /a\p{RGI_Emoji_Flag_Sequence}/u
   ║     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^------- error
╚══╩════════════════
