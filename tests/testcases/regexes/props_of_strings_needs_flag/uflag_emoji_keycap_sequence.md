...
- Path: tests/testcases/regexes/props_of_strings_needs_flag/uflag_emoji_keycap_sequence.md

> :: regexes : props of strings needs flag
>
> ::> uflag emoji keycap sequence
>
...
start@1:0, error@1:4
╔══╦════════════════
 1 ║ x = /a\p{Emoji_Keycap_Sequence}/u
   ║     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^------- error
╚══╩════════════════
