...
- Path: tests/testcases/regexes/props_of_strings_needs_flag/noflag_rgi_emoji.md

> :: regexes : props of strings needs flag
>
> ::> noflag rgi emoji
>
> without u or v this `RGI_Emoji` escape is the annexB identity escape of `p`
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          ...
          value: null,
          regex: { pattern: 'a\\p{RGI_Emoji}', flags: '' },
          raw: '/a\\p{RGI_Emoji}/'
        }
      }
    }
