...
- Path: tests/testcases/regexes/props_of_strings_needs_flag/uflag_rgi_emoji_zwj_sequence.md

> :: regexes : props of strings needs flag
>
> ::> uflag rgi emoji zwj sequence
>
...
`````js
x = /a\p{RGI_Emoji_ZWJ_Sequence}/u
`````
...
start@1:0, error@1:4
╔══╦════════════════
 1 ║ x = /a\p{RGI_Emoji_ZWJ_Sequence}/u
   ║     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^------- error
╚══╩════════════════
