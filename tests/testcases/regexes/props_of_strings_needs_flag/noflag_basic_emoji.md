...
- Path: tests/testcases/regexes/props_of_strings_needs_flag/noflag_basic_emoji.md

> :: regexes : props of strings needs flag
>
> ::> noflag basic emoji
>
> without u or v this `Basic_Emoji` escape is the annexB identity escape of `p`
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          ...
          value: null,
          regex: { pattern: 'a\\p{Basic_Emoji}', flags: '' },
          raw: '/a\\p{Basic_Emoji}/'
        }
      }
    }
