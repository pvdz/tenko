...
- Path: tests/testcases/regexes/props_of_strings_needs_flag/uflag_rgi_emoji_modifier_sequence.md

> :: regexes : props of strings needs flag
>
> ::> uflag rgi emoji modifier sequence
>
> a property of strings is not valid with the u flag
...
`````js
x = /a\p{RGI_Emoji_Modifier_Sequence}/u
`````
...
start@1:0, error@1:4
╔══╦════════════════
 1 ║ x = /a\p{RGI_Emoji_Modifier_Sequence}/u
   ║     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^------- error
╚══╩════════════════
