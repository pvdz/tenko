...
- Path: tests/testcases/regexes/charclass_nested_group_close/bare_rbracket_tail_annexb.md

> :: regexes : charclass nested group close
>
> ::> bare rbracket tail annexb
>
> bare ] in the class tail is annexb-only, but the group still closes cleanly
