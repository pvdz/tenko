...
- Path: tests/testcases/regexes/nested_negated_class_strings/nested_rgi_emoji_zwj_sequence.md

> :: regexes : nested negated class strings
>
> ::> nested rgi emoji zwj sequence
>
> a nested negated class may not contain the `RGI_Emoji_ZWJ_Sequence` property of strings
...
start@1:0, error@1:4
╔══╦════════════════
 1 ║ x = /[[^\p{RGI_Emoji_ZWJ_Sequence}]]/v
   ║     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^------- error
╚══╩════════════════
