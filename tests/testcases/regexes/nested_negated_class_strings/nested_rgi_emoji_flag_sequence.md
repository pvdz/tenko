...
- Path: tests/testcases/regexes/nested_negated_class_strings/nested_rgi_emoji_flag_sequence.md

> :: regexes : nested negated class strings
>
> ::> nested rgi emoji flag sequence
>
> a nested negated class may not contain the `RGI_Emoji_Flag_Sequence` property of strings
...
start@1:0, error@1:4
╔══╦════════════════
 1 ║ x = /[[^\p{RGI_Emoji_Flag_Sequence}]]/v
   ║     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^------- error
╚══╩════════════════
