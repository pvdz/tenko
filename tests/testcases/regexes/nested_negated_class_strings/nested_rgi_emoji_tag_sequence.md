...
- Path: tests/testcases/regexes/nested_negated_class_strings/nested_rgi_emoji_tag_sequence.md

> :: regexes : nested negated class strings
>
> ::> nested rgi emoji tag sequence
>
> a nested negated class may not contain the `RGI_Emoji_Tag_Sequence` property of strings
...
start@1:0, error@1:4
╔══╦════════════════
 1 ║ x = /[[^\p{RGI_Emoji_Tag_Sequence}]]/v
   ║     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^------- error
╚══╩════════════════
