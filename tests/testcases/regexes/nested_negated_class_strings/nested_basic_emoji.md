...
- Path: tests/testcases/regexes/nested_negated_class_strings/nested_basic_emoji.md

> :: regexes : nested negated class strings
>
> ::> nested basic emoji
>
> a nested negated class may not contain the `Basic_Emoji` property of strings
