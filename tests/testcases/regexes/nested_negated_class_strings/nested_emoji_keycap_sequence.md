...
- Path: tests/testcases/regexes/nested_negated_class_strings/nested_emoji_keycap_sequence.md

> :: regexes : nested negated class strings
>
> ::> nested emoji keycap sequence
>
> a nested negated class may not contain the `Emoji_Keycap_Sequence` property of strings
