...
`````
throws: Lexer error!
    Regex: Encountered incorrect range (left>right, 97 > 5, 0x61 > 0x5) which is illegal with u-flag; Regex contained syntax that is invalid with the u-flag but the u-flag was present
