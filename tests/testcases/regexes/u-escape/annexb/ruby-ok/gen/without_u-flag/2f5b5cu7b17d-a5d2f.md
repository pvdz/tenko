...
`````
throws: Lexer error!
    Regex: Encountered incorrect range (left>right, 125 > 97, 0x7d > 0x61) when parsing as if without u-flag; Regex contained syntax that is only valid with the u-flag but the u-flag was not present
