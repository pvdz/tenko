...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_range_dash_region.md

> :: regexes : charclass : nested boundary
>
> ::> nested range dash region
>
> range in nested class then dash and literal in region
