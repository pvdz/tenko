...
- Path: tests/testcases/regexes/charclass/nested_boundary/triple_nested_tail_rbrackets.md

> :: regexes : charclass : nested boundary
>
> ::> triple nested tail rbrackets
>
> triple nested brackets leave two bare body rbrackets without v
