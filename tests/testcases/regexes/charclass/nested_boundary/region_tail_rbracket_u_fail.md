...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_tail_rbracket_u_fail.md

> :: regexes : charclass : nested boundary
>
> ::> region tail rbracket u fail
>
> region content plus tail rbracket is invalid with the u flag
