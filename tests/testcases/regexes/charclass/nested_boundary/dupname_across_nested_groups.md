...
- Path: tests/testcases/regexes/charclass/nested_boundary/dupname_across_nested_groups.md

> :: regexes : charclass : nested boundary
>
> ::> dupname across nested groups
>
> same name in sibling alternatives across nested groups
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          ...
          value: null,
          regex: { pattern: '[[a](?:(?<n>y))|(?:(?<n>z))]', flags: 'g' },
          raw: '/[[a](?:(?<n>y))|(?:(?<n>z))]/g'
        }
      }
    }
