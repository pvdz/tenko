...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_lazy_question.md

> :: regexes : charclass : nested boundary
>
> ::> region lazy question
>
> lazy question quantifier after class close is valid body syntax
