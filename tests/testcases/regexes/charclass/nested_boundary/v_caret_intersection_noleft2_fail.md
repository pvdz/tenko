...
- Path: tests/testcases/regexes/charclass/nested_boundary/v_caret_intersection_noleft2_fail.md

> :: regexes : charclass : nested boundary
>
> ::> v caret intersection noleft2 fail
>
> intersection after caret with nothing else
