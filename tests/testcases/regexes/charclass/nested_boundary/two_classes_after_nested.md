...
- Path: tests/testcases/regexes/charclass/nested_boundary/two_classes_after_nested.md

> :: regexes : charclass : nested boundary
>
> ::> two classes after nested
>
> nested class closed twice then another class
