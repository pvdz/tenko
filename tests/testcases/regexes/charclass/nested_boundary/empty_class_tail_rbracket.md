...
- Path: tests/testcases/regexes/charclass/nested_boundary/empty_class_tail_rbracket.md

> :: regexes : charclass : nested boundary
>
> ::> empty class tail rbracket
>
> literal rbracket class in v reading is class plus bare rbracket without v
