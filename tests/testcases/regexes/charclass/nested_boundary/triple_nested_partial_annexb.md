...
- Path: tests/testcases/regexes/charclass/nested_boundary/triple_nested_partial_annexb.md

> :: regexes : charclass : nested boundary
>
> ::> triple nested partial annexb
>
> triple nesting closed twice leaves one bare body rbracket
