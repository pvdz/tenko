...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_slash_before_tail_rbracket.md

> :: regexes : charclass : nested boundary
>
> ::> nested slash before tail rbracket
>
> slash inside nested class before tail rbracket
