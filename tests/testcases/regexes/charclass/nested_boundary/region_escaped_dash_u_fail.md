...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_escaped_dash_u_fail.md

> :: regexes : charclass : nested boundary
>
> ::> region escaped dash u fail
>
> escaped dash in the region body is not a valid u identity escape
