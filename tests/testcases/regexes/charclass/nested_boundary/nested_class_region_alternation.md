...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_class_region_alternation.md

> :: regexes : charclass : nested boundary
>
> ::> nested class region alternation
>
> alternation pipe in region after class close
