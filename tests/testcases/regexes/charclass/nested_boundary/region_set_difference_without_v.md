...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_set_difference_without_v.md

> :: regexes : charclass : nested boundary
>
> ::> region set difference without v
>
> set difference between classes reads as two literal body dashes without v
