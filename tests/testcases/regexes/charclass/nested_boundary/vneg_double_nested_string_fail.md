...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_double_nested_string_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg double nested string fail
>
> negated class two levels over a multi char string
