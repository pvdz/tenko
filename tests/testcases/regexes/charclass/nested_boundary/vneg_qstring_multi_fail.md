...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_qstring_multi_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg qstring multi fail
>
> negated class with a multi char q string may contain strings
