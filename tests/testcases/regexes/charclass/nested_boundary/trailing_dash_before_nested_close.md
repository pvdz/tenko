...
- Path: tests/testcases/regexes/charclass/nested_boundary/trailing_dash_before_nested_close.md

> :: regexes : charclass : nested boundary
>
> ::> trailing dash before nested close
>
> trailing dash before the class close is a literal
