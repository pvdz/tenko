...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_nested_qstring_multi_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg nested qstring multi fail
>
> negated class over a nested class with a multi char q string
