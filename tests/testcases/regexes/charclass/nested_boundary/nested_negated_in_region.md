...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_negated_in_region.md

> :: regexes : charclass : nested boundary
>
> ::> nested negated in region
>
> negated nested class then region literal and tail rbracket
