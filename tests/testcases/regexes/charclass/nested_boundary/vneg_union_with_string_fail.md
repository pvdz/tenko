...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_union_with_string_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg union with string fail
>
> negated union that includes a string operand
