...
- Path: tests/testcases/regexes/charclass/nested_boundary/negated_empty_then_tail.md

> :: regexes : charclass : nested boundary
>
> ::> negated empty then tail
>
> negated empty class then bare rbracket body atom
