...
- Path: tests/testcases/regexes/charclass/nested_boundary/qstring_sansv_annexb_batch.md

> :: regexes : charclass : nested boundary
>
> ::> qstring sansv annexb batch
>
> q string without v is annex B identity escape and braces
