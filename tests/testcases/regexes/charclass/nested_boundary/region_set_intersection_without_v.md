...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_set_intersection_without_v.md

> :: regexes : charclass : nested boundary
>
> ::> region set intersection without v
>
> set intersection between classes reads as two literal body amps without v
