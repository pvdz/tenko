...
- Path: tests/testcases/regexes/charclass/nested_boundary/v_empty_then_unterminated_fail.md

> :: regexes : charclass : nested boundary
>
> ::> v empty then unterminated fail
>
> empty class then unterminated nested class with v
