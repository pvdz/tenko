...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_alternation_two_atoms.md

> :: regexes : charclass : nested boundary
>
> ::> region alternation two atoms
>
> alternation between literals in the region
