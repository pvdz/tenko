...
- Path: tests/testcases/regexes/charclass/nested_boundary/regex_optional_chain.md

> :: regexes : charclass : nested boundary
>
> ::> regex optional chain
>
> optional chain on a boundary regex
...
tokens (7x):
       IDENT PUNC_EQ REGEXN QMARK_DOT IDENT PUNC_SEMI
`````
