...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_class_tail_rbracket.md

> :: regexes : charclass : nested boundary
>
> ::> nested class tail rbracket
>
> nested class with trailing rbracket needs webcompat without v
