...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_syntaxchar_escape_u.md

> :: regexes : charclass : nested boundary
>
> ::> region syntaxchar escape u
>
> an unescaped nested `[` inside a character class is illegal with the u flag, regardless of the escape that follows
