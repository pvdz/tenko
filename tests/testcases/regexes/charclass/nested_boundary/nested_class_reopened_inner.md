...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_class_reopened_inner.md

> :: regexes : charclass : nested boundary
>
> ::> nested class reopened inner
>
> two nested classes inside one v reading
