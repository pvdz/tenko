...
- Path: tests/testcases/regexes/charclass/nested_boundary/triple_nested_two_tails_u_fail.md

> :: regexes : charclass : nested boundary
>
> ::> triple nested two tails u fail
>
> two bare body rbrackets from triple nesting are invalid with u
