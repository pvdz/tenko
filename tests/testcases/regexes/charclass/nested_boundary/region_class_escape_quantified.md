...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_class_escape_quantified.md

> :: regexes : charclass : nested boundary
>
> ::> region class escape quantified
>
> quantified class escape in the region
