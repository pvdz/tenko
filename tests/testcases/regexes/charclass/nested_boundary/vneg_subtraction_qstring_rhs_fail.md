...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_subtraction_qstring_rhs_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg subtraction qstring rhs fail
>
> negated subtraction minuend q string with q string subtrahend
