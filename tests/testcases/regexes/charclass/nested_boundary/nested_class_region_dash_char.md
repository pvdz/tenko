...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_class_region_dash_char.md

> :: regexes : charclass : nested boundary
>
> ::> nested class region dash char
>
> dash and char in region after class close
