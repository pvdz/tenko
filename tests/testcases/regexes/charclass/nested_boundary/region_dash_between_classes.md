...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_dash_between_classes.md

> :: regexes : charclass : nested boundary
>
> ::> region dash between classes
>
> single dash between two classes is a literal body dash without v
