...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_class_benign_region_char.md

> :: regexes : charclass : nested boundary
>
> ::> nested class benign region char
>
> literal char between class close and tail rbracket
