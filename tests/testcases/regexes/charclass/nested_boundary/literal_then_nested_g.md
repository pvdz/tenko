...
- Path: tests/testcases/regexes/charclass/nested_boundary/literal_then_nested_g.md

> :: regexes : charclass : nested boundary
>
> ::> literal then nested g
>
> empty class then nested class without v: the trailing rbracket is a bare body bracket (annex B only)
