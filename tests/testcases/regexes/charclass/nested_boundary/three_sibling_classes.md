...
- Path: tests/testcases/regexes/charclass/nested_boundary/three_sibling_classes.md

> :: regexes : charclass : nested boundary
>
> ::> three sibling classes
>
> three sibling nested classes and tail rbracket
