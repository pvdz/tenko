...
- Path: tests/testcases/regexes/charclass/nested_boundary/regex_member_source.md

> :: regexes : charclass : nested boundary
>
> ::> regex member source
>
> member access on a boundary regex
...
tokens (7x):
       IDENT PUNC_EQ REGEXN PUNC_DOT IDENT PUNC_SEMI
`````
