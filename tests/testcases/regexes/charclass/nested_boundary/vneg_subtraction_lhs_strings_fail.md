...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_subtraction_lhs_strings_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg subtraction lhs strings fail
>
> negated subtraction whose minuend may contain strings
