...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_class_region_quantifier.md

> :: regexes : charclass : nested boundary
>
> ::> nested class region quantifier
>
> single quantifier right after class close is valid body syntax
