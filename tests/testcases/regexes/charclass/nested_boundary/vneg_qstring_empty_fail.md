...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_qstring_empty_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg qstring empty fail
>
> negated class with an empty q string may contain strings
