...
- Path: tests/testcases/regexes/charclass/nested_boundary/vneg_intersection_both_strings_fail.md

> :: regexes : charclass : nested boundary
>
> ::> vneg intersection both strings fail
>
> negated intersection where both operands may contain strings
