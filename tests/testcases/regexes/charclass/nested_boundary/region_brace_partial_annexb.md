...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_brace_partial_annexb.md

> :: regexes : charclass : nested boundary
>
> ::> region brace partial annexb
>
> partial braced quantifier text is a literal in the region
