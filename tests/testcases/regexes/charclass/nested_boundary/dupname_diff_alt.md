...
- Path: tests/testcases/regexes/charclass/nested_boundary/dupname_diff_alt.md

> :: regexes : charclass : nested boundary
>
> ::> dupname diff alt
>
> duplicate named group in different alternatives in the region
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          ...
          value: null,
          regex: { pattern: '[[a](?<n>y)|(?<n>y)]', flags: 'g' },
          raw: '/[[a](?<n>y)|(?<n>y)]/g'
        }
      }
    }
