...
- Path: tests/testcases/regexes/charclass/nested_boundary/double_repro_classes.md

> :: regexes : charclass : nested boundary
>
> ::> double repro classes
>
> two adjacent repro classes in one regex
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          type: 'Literal',
          loc:{start:{line:1,column:2},end:{line:1,column:51},source:''},
          value: null,
          regex: {
            pattern: '[-[\\]{}()*+?.,\\\\^$|#\\s][-[\\]{}()*+?.,\\\\^$|#\\s]',
            flags: 'g'
