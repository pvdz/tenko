...
- Path: tests/testcases/regexes/charclass/nested_boundary/tail_rbracket_gu_fail.md

> :: regexes : charclass : nested boundary
>
> ::> tail rbracket gu fail
>
> tail rbracket with g and u flags is a bare bracket error
