...
- Path: tests/testcases/regexes/charclass/nested_boundary/negated_nested_tail_rbracket.md

> :: regexes : charclass : nested boundary
>
> ::> negated nested tail rbracket
>
> negated class with nested bracket and tail rbracket
