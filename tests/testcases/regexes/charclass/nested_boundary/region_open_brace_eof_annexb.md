...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_open_brace_eof_annexb.md

> :: regexes : charclass : nested boundary
>
> ::> region open brace eof annexb
>
> open brace at region end before slash is an annex B literal
