...
- Path: tests/testcases/regexes/charclass/nested_boundary/qstring_sansv_annexb.md

> :: regexes : charclass : nested boundary
>
> ::> qstring sansv annexb
>
> q string without v reads as annex B identity escape and brace atoms
