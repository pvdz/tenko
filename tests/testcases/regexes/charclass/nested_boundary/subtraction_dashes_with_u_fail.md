...
- Path: tests/testcases/regexes/charclass/nested_boundary/subtraction_dashes_with_u_fail.md

> :: regexes : charclass : nested boundary
>
> ::> subtraction dashes with u fail
>
> with u the dashes read as the out-of-order range a-to-dash
