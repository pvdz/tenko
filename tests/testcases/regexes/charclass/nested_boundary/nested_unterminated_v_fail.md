...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_unterminated_v_fail.md

> :: regexes : charclass : nested boundary
>
> ::> nested unterminated v fail
>
> v reading is unterminated when the non-v class exits at the slash
