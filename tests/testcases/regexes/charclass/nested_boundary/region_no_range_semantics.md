...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_no_range_semantics.md

> :: regexes : charclass : nested boundary
>
> ::> region no range semantics
>
> region chars are body atoms and never form class ranges
