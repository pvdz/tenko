...
- Path: tests/testcases/regexes/charclass/nested_boundary/regex_in_let_decl.md

> :: regexes : charclass : nested boundary
>
> ::> regex in let decl
>
> tail rbracket regex as let initializer
...
tokens (6x):
       ID_let IDENT PUNC_EQ REGEXN PUNC_SEMI
`````
