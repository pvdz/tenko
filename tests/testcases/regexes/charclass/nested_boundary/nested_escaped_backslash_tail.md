...
- Path: tests/testcases/regexes/charclass/nested_boundary/nested_escaped_backslash_tail.md

> :: regexes : charclass : nested boundary
>
> ::> nested escaped backslash tail
>
> escaped backslash inside nested class with tail rbracket
