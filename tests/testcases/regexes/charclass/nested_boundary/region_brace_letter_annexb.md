...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_brace_letter_annexb.md

> :: regexes : charclass : nested boundary
>
> ::> region brace letter annexb
>
> brace with a non digit is a literal in the region
