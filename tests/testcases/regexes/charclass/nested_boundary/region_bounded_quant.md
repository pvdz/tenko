...
- Path: tests/testcases/regexes/charclass/nested_boundary/region_bounded_quant.md

> :: regexes : charclass : nested boundary
>
> ::> region bounded quant
>
> bounded quantifier after class close is valid body syntax
