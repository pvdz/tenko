...
- Path: tests/testcases/optional_chaining/chaining_leak/args_tagged_bad_escape.md

> :: optional chaining : chaining leak
>
> ::> args tagged bad escape
>
> tagged template with an illegal escape as call arg (es2018+)
...
tokens (8x):
       IDENT QMARK_DOT PUNC_PAREN_OPEN IDENT TICK_BAD_PURE
