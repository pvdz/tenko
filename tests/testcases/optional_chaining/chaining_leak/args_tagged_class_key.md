...
- Path: tests/testcases/optional_chaining/chaining_leak/args_tagged_class_key.md

> :: optional chaining : chaining leak
>
> ::> args tagged class key
>
> tagged template as computed class key in a call arg
...
tokens (17x):
       IDENT QMARK_DOT PUNC_PAREN_OPEN ID_class PUNC_CURLY_OPEN
