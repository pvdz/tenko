...
- Path: tests/testcases/classes/field_init_await_nesting/instance_class_method.md
...
`````js
class A { x = class { m(){ return await } } }
`````
                ...
                body: [
                  {
                    ...
                    loc:{start:{line:1,column:22},end:{line:1,column:41},source:''},
                    key: {
                      type: 'Identifier',
...
tokens (18x):
       ID_class IDENT PUNC_CURLY_OPEN IDENT PUNC_EQ ID_class
...
╔══╦═════════════════
 1 ║ class A { x = class { m(){ return await } } }
   ║                                         ^------- error
╚══╩═════════════════
