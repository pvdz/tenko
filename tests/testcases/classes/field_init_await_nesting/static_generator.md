...
- Path: tests/testcases/classes/field_init_await_nesting/static_generator.md
...
`````js
class A { static x = function*(){ return await } }
`````
...
╔══╦═════════════════
 1 ║ class A { static x = function*(){ return await } }
   ║                                                ^------- error
╚══╩═════════════════
