...
- Path: tests/testcases/classes/field_init_await_nesting/instance_arrow_block.md

> :: classes : field init await nesting
>
> ::> instance arrow block
>
...
tokens (15x):
       ...
       PUNC_PAREN_CLOSE PUNC_EQ_GT PUNC_CURLY_OPEN ID_return ID_await
