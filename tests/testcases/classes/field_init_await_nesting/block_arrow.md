...
- Path: tests/testcases/classes/field_init_await_nesting/block_arrow.md

> :: classes : field init await nesting
>
> ::> block arrow
>
> a static block may not use `await` at all
...
tokens (13x):
       ...
       PUNC_PAREN_OPEN PUNC_PAREN_CLOSE PUNC_EQ_GT ID_await ASI
