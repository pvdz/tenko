...
- Path: tests/testcases/classes/async_newline_field_asi/derived.md

> :: classes : async newline field asi
>
> ::> derived
>
> the same in a derived class
  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,column:18},end:{line:2,column:7},source:''},
        body: [
          {
...
tokens (13x):
       ID_class IDENT ID_extends IDENT PUNC_CURLY_OPEN ID_async IDENT
