...
- Path: tests/testcases/classes/async_newline_field_asi/ok_get_nl.md

> :: classes : async newline field asi
>
> ::> ok get nl
>
> a newline after `get` still gives a getter
        ...
        body: [
          {
            ...
            loc:{start:{line:1,column:10},end:{line:2,column:5},source:''},
            key: {
              type: 'Identifier',
