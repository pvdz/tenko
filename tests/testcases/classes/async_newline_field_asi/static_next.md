...
- Path: tests/testcases/classes/async_newline_field_asi/static_next.md

> :: classes : async newline field asi
>
> ::> static next
>
> a static method after it
  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,column:8},end:{line:2,column:14},source:''},
        body: [
          {
...
tokens (12x):
       ID_class IDENT PUNC_CURLY_OPEN ID_async ID_static IDENT
