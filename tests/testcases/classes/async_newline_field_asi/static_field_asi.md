...
- Path: tests/testcases/classes/async_newline_field_asi/static_field_asi.md

> :: classes : async newline field asi
>
> ::> static field asi
>
> a static `async` field then another field
...
tokens (10x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static ID_async IDENT PUNC_EQ
