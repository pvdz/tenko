...
- Path: tests/testcases/classes/async_newline_field_asi/getter.md
  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,column:8},end:{line:2,column:11},source:''},
        body: [
          {
...
tokens (12x):
       ID_class IDENT PUNC_CURLY_OPEN ID_async ID_get IDENT
