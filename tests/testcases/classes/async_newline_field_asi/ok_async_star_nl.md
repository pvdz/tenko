...
- Path: tests/testcases/classes/async_newline_field_asi/ok_async_star_nl.md

> :: classes : async newline field asi
>
> ::> ok async star nl
>
> the restricted position is between async and the star, so a newline after the star is fine
