...
- Path: tests/testcases/classes/async_newline_field_asi/with_init.md

> :: classes : async newline field asi
>
> ::> with init
>
> a field with an initializer after it
...
tokens (9x):
       ID_class IDENT PUNC_CURLY_OPEN ID_async IDENT PUNC_EQ
