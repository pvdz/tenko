...
- Path: tests/testcases/classes/async_newline_field_asi/static_async.md

> :: classes : async newline field asi
>
> ::> static async
>
> the same for a static `async` field
...
tokens (12x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static ID_async IDENT
