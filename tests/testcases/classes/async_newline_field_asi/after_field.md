...
- Path: tests/testcases/classes/async_newline_field_asi/after_field.md

> :: classes : async newline field asi
>
> ::> after field
>
> the same after another field
...
tokens (15x):
       ...
       PUNC_SEMI ID_async IDENT PUNC_PAREN_OPEN PUNC_PAREN_CLOSE
