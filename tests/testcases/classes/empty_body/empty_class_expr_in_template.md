...
- Path: tests/testcases/classes/empty_body/empty_class_expr_in_template.md

> :: classes : empty body
>
> ::> empty class expr in template
>
> Empty class expression inside template literal
...
tokens (10x):
       ID_var IDENT PUNC_EQ TICK_HEAD ID_class PUNC_CURLY_OPEN
