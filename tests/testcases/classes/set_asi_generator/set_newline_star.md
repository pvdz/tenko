...
- Path: tests/testcases/classes/set_asi_generator/set_newline_star.md

> :: classes : set asi generator
>
> ::> set newline star
>
> ASI between field named set and a generator method
...
tokens (13x):
       ID_class IDENT PUNC_CURLY_OPEN ID_set PUNC_STAR IDENT
