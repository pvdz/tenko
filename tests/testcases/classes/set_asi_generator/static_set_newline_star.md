...
- Path: tests/testcases/classes/set_asi_generator/static_set_newline_star.md

> :: classes : set asi generator
>
> ::> static set newline star
>
> ASI between static field named set and a generator method
...
tokens (14x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static ID_set PUNC_STAR IDENT
