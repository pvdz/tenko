...
- Path: tests/testcases/classes/static_as_field_name/instance_field_without_init_class_expr.md

> :: classes : static as field name
>
> ::> instance field without init class expr
>
> static as instance field name without initializer in class expr
