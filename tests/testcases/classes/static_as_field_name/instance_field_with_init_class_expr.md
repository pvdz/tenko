...
- Path: tests/testcases/classes/static_as_field_name/instance_field_with_init_class_expr.md

> :: classes : static as field name
>
> ::> instance field with init class expr
>
> static as instance field name with initializer in class expr
...
tokens (12x):
       ID_var IDENT PUNC_EQ ID_class PUNC_CURLY_OPEN ID_static PUNC_EQ
