...
- Path: tests/testcases/classes/private_in/stuffed_delete_group.md

> :: classes : private in
>
> ::> stuffed delete group
>
> delete of group with or private in
...
`````js
class C { #e; m() { return delete (x || #e in this); } }
`````
...
tokens (22x):
       ...
       ID_delete PUNC_PAREN_OPEN IDENT PUNC_OR_OR ID_PRIVATE_IDENT
       ID_in ID_this PUNC_PAREN_CLOSE PUNC_SEMI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
