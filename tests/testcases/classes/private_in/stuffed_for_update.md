...
- Path: tests/testcases/classes/private_in/stuffed_for_update.md

> :: classes : private in
>
> ::> stuffed for update
>
> or private in as for update
...
tokens (24x):
       ...
       PUNC_PAREN_OPEN PUNC_SEMI PUNC_SEMI IDENT PUNC_OR_OR
       ID_PRIVATE_IDENT ID_in ID_this PUNC_PAREN_CLOSE ID_break
