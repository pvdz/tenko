...
- Path: tests/testcases/classes/private_in/stuffed_computed_member.md

> :: classes : private in
>
> ::> stuffed computed member
>
> or private in as computed member expression
...
tokens (21x):
       ...
       PUNC_BRACKET_OPEN IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in
       ID_this PUNC_BRACKET_CLOSE PUNC_SEMI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
