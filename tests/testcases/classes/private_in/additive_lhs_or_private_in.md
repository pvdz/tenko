...
- Path: tests/testcases/classes/private_in/additive_lhs_or_private_in.md

> :: classes : private in
>
> ::> additive lhs or private in
>
> additive expr then or then private in
...
`````js
class C { #e; m() { return a + b || #e in this; } }
`````
...
tokens (21x):
       ...
       IDENT PUNC_PLUS IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this
