...
- Path: tests/testcases/classes/private_in/ternary_test_private_in_after_or.md

> :: classes : private in
>
> ::> ternary test private in after or
>
> or with private in as ternary test
...
`````js
class C { #e; m() { return x || #e in this ? y : z; } }
`````
...
tokens (23x):
       ...
       IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this PUNC_QMARK
