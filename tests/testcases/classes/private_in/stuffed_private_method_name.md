...
- Path: tests/testcases/classes/private_in/stuffed_private_method_name.md

> :: classes : private in
>
> ::> stuffed private method name
>
> private method name checked after or
...
`````js
class C { #m() {} g() { return x || #m in this; } }
`````
...
tokens (22x):
       ID_class IDENT PUNC_CURLY_OPEN ID_PRIVATE_IDENT PUNC_PAREN_OPEN
