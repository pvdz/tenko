...
- Path: tests/testcases/classes/private_in/stuffed_array_spread.md

> :: classes : private in
>
> ::> stuffed array spread
>
> or private in as spread argument
...
tokens (21x):
       ...
       PUNC_BRACKET_OPEN PUNC_DOT_DOT_DOT IDENT PUNC_OR_OR
       ID_PRIVATE_IDENT ID_in ID_this PUNC_BRACKET_CLOSE PUNC_SEMI
