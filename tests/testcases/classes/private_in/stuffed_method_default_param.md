...
- Path: tests/testcases/classes/private_in/stuffed_method_default_param.md

> :: classes : private in
>
> ::> stuffed method default param
>
> or private in as method default parameter
...
`````js
class C { #e; m(a = x || #e in this) { return a; } }
`````
        ...
        body: [
          ...
          },
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,column:37},end:{line:1,column:50},source:''},
                body: [
                  {
...
tokens (22x):
       ...
       ID_in ID_this PUNC_PAREN_CLOSE PUNC_CURLY_OPEN ID_return IDENT
