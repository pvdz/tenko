...
- Path: tests/testcases/classes/private_in/nullish_parenthesized_private_in.md

> :: classes : private in
>
> ::> nullish parenthesized private in
>
> nullish with parenthesized private in
...
`````js
class C { #e; m() { return x ?? (#e in this); } }
`````
                ...
                body: [
                  {
                    ...
                    argument: {
                      ...
                      loc:{start:{line:1,column:27},end:{line:1,column:44},source:''},
                      left: {
                        type: 'Identifier',
...
tokens (21x):
       ...
       IDENT QMARK_QMARK PUNC_PAREN_OPEN ID_PRIVATE_IDENT ID_in
       ID_this PUNC_PAREN_CLOSE PUNC_SEMI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
