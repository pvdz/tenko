...
- Path: tests/testcases/classes/private_in/stuffed_relational_after_in.md

> :: classes : private in
>
> ::> stuffed relational after in
>
> private in result compared with less-than
...
tokens (21x):
       ...
       IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this PUNC_LT IDENT
