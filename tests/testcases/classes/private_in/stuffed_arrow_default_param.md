...
- Path: tests/testcases/classes/private_in/stuffed_arrow_default_param.md

> :: classes : private in
>
> ::> stuffed arrow default param
>
> or private in as arrow default parameter
...
`````js
class C { #e; m() { return (a = x || #e in this) => a; } }
`````
                ...
                body: [
                  {
                    ...
                    argument: {
                      ...
                      loc:{start:{line:1,column:27},end:{line:1,column:53},source:''},
                      params: [
                        {
...
tokens (25x):
       ...
       PUNC_PAREN_OPEN IDENT PUNC_EQ IDENT PUNC_OR_OR ID_PRIVATE_IDENT
       ID_in ID_this PUNC_PAREN_CLOSE PUNC_EQ_GT IDENT PUNC_SEMI
