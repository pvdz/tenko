...
- Path: tests/testcases/classes/private_in/stuffed_computed_obj_key.md

> :: classes : private in
>
> ::> stuffed computed obj key
>
> or private in as computed object key
...
tokens (26x):
       ...
       PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this PUNC_BRACKET_CLOSE
