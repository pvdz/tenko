...
- Path: tests/testcases/classes/private_in/stuffed_void_group.md

> :: classes : private in
>
> ::> stuffed void group
>
> void of group with or private in
...
`````js
class C { #e; m() { return void (x || #e in this); } }
`````
...
tokens (22x):
       ...
       ID_void PUNC_PAREN_OPEN IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in
