...
- Path: tests/testcases/classes/private_in/unary_lhs_or_private_in.md

> :: classes : private in
>
> ::> unary lhs or private in
>
> unary lhs then or then private in
...
tokens (20x):
       ...
       PUNC_EXCL IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this
