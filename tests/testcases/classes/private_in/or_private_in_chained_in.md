...
- Path: tests/testcases/classes/private_in/or_private_in_chained_in.md

> :: classes : private in
>
> ::> or private in chained in
>
> or then private in chained with second in
...
`````js
class C { #e; m() { return x || #e in this in y; } }
`````
...
tokens (21x):
       ...
       IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this ID_in IDENT
