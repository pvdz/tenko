...
- Path: tests/testcases/classes/private_in/stuffed_ternary_both_branches.md

> :: classes : private in
>
> ::> stuffed ternary both branches
>
> or private in in both ternary branches
...
`````js
class C { #e; m() { a ? x || #e in this : x || #e in this; } }
`````
...
tokens (26x):
       ...
       PUNC_QMARK IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this
       PUNC_COLON IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this
