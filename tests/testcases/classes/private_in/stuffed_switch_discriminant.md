...
- Path: tests/testcases/classes/private_in/stuffed_switch_discriminant.md

> :: classes : private in
>
> ::> stuffed switch discriminant
>
> or private in as switch discriminant
...
`````js
class C { #e; m() { switch (x || #e in this) {} } }
`````
