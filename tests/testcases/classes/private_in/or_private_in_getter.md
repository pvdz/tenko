...
- Path: tests/testcases/classes/private_in/or_private_in_getter.md

> :: classes : private in
>
> ::> or private in getter
>
> private in after or inside getter
...
`````js
class C { #e; get g() { return x || #e in this; } }
`````
...
tokens (20x):
       ...
       ID_return IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this
