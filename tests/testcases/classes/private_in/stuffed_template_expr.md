...
- Path: tests/testcases/classes/private_in/stuffed_template_expr.md

> :: classes : private in
>
> ::> stuffed template expr
>
> or private in inside template expression
...
tokens (21x):
       ...
       TICK_HEAD IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this
       TICK_TAIL PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
`````
