...
- Path: tests/testcases/classes/private_in/private_in_call_rhs_after_and.md

> :: classes : private in
>
> ::> private in call rhs after and
>
> private in with call expression rhs after and
...
tokens (21x):
       ...
       IDENT PUNC_AND_AND ID_PRIVATE_IDENT ID_in IDENT PUNC_PAREN_OPEN
