...
- Path: tests/testcases/classes/private_in/logical_or_chain_private_in_last.md

> :: classes : private in
>
> ::> logical or chain private in last
>
> private in as last operand of or chain
...
`````js
class C { #e; m() { return x || y || #e in this; } }
`````
...
tokens (21x):
       ...
       IDENT PUNC_OR_OR IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in
