...
- Path: tests/testcases/classes/private_in/stuffed_instanceof_after_in.md

> :: classes : private in
>
> ::> stuffed instanceof after in
>
> private in result as lhs of instanceof
...
`````js
class C { #e; m() { return x || #e in this instanceof y; } }
`````
                ...
                body: [
                  {
                    ...
                    argument: {
                      ...
                      loc:{start:{line:1,column:27},end:{line:1,column:55},source:''},
                      left: {
                        type: 'Identifier',
...
tokens (21x):
       ...
       IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in ID_this ID_instanceof
...
class C{
#e;
m(){return (x || ((#e in this) instanceof y));};
}
````
