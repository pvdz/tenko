...
- Path: tests/testcases/classes/private_in/stuffed_sequence_group_lhs.md

> :: classes : private in
>
> ::> stuffed sequence group lhs
>
> private in as first element of grouped sequence
...
`````js
class C { #e; m() { return (#e in this, x); } }
`````
...
tokens (21x):
       ...
       PUNC_PAREN_OPEN ID_PRIVATE_IDENT ID_in ID_this PUNC_COMMA IDENT
