...
- Path: tests/testcases/classes/private_in/stuffed_if_else.md

> :: classes : private in
>
> ::> stuffed if else
>
> or private in in if with else
...
`````js
class C { #e; m() { if (x || #e in this) y; else z; } }
`````
...
tokens (25x):
       ...
       PUNC_PAREN_CLOSE IDENT PUNC_SEMI ID_else IDENT PUNC_SEMI
