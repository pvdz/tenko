...
- Path: tests/testcases/classes/private_in/private_in_chained_in.md

> :: classes : private in
>
> ::> private in chained in
>
> private in result as lhs of another in
...
`````js
class C { #e; m() { return #e in this in y; } }
`````
...
tokens (19x):
       ...
       ID_PRIVATE_IDENT ID_in ID_this ID_in IDENT PUNC_SEMI
