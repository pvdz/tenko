...
- Path: tests/testcases/classes/private_in/private_in_member_expr_rhs.md

> :: classes : private in
>
> ::> private in member expr rhs
>
> private in with member expression rhs after or
...
tokens (21x):
       ...
       IDENT PUNC_OR_OR ID_PRIVATE_IDENT ID_in IDENT PUNC_DOT IDENT
