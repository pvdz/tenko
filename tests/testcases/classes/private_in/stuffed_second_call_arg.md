...
- Path: tests/testcases/classes/private_in/stuffed_second_call_arg.md

> :: classes : private in
>
> ::> stuffed second call arg
>
> or private in as second call argument
...
tokens (23x):
       ...
       PUNC_PAREN_OPEN IDENT PUNC_COMMA IDENT PUNC_OR_OR
