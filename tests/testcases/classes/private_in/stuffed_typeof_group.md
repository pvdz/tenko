...
- Path: tests/testcases/classes/private_in/stuffed_typeof_group.md

> :: classes : private in
>
> ::> stuffed typeof group
>
> typeof of group with or private in
...
`````js
class C { #e; m() { return typeof (x || #e in this); } }
`````
...
tokens (22x):
       ...
       ID_typeof PUNC_PAREN_OPEN IDENT PUNC_OR_OR ID_PRIVATE_IDENT
