...
- Path: tests/testcases/classes/private_in/stuffed_async_gen_yield.md

> :: classes : private in
>
> ::> stuffed async gen yield
>
> or private in as async generator yield argument
...
`````js
class C { #e; async *m() { yield x || #e in this; } }
`````
...
tokens (21x):
       ...
       ID_async PUNC_STAR IDENT PUNC_PAREN_OPEN PUNC_PAREN_CLOSE
       PUNC_CURLY_OPEN ID_yield IDENT PUNC_OR_OR ID_PRIVATE_IDENT
