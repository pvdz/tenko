...
- Path: tests/testcases/classes/extending/class_extends_async_function.md

> :: classes : extending
>
> ::> class extends async function
>
> class extends async function expression
...
tokens (14x):
       PUNC_PAREN_OPEN ID_class ID_extends ID_async ID_function
