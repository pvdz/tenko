...
- Path: tests/testcases/classes/extending/lefthandside/gen/generator_wrapped/28oh_yes29.md
...
tokens (18x):
       ...
       PUNC_CURLY_OPEN ID_class IDENT ID_extends PUNC_PAREN_OPEN IDENT
