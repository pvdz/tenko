...
- Path: tests/testcases/classes/extending/lefthandside/gen/for-in_lhs/await_x_assignable_func.md

> :: classes : extending : lefthandside : gen : for-in lhs
>
> ::> await x assignable func
## PASS
        ...
        body: [
          {
            ...
            left: {
              ...
              loc:{start:{line:2,column:7},end:{line:2,column:18},source:''},
              computed: false,
              optional: false,
              object: {
...
tokens (20x):
       ...
       PUNC_CURLY_OPEN ID_for PUNC_PAREN_OPEN PUNC_PAREN_OPEN ID_await
       IDENT PUNC_PAREN_CLOSE PUNC_DOT IDENT ID_in IDENT
...
````js
async function f() {for (((await x).x) in x) ;}
````
