...
- Path: tests/testcases/classes/extends_computed/super_prop_computed_key/extending_calss_when_wrapped_in_non-extending_class.md

> :: classes : extends computed : super prop computed key
>
> ::> extending calss when wrapped in non-extending class
>
