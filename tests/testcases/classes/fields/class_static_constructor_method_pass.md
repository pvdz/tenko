...
- Path: tests/testcases/classes/fields/class_static_constructor_method_pass.md

> :: classes : fields
>
> ::> class static constructor method pass
>
> Static constructor METHOD is valid (only fields are restricted).
