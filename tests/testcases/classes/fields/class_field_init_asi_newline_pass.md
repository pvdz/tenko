...
- Path: tests/testcases/classes/fields/class_field_init_asi_newline_pass.md

> :: classes : fields
>
> ::> class field init asi newline pass
>
> ASI in field declarations: newline after initializer allows next class element without semicolon.
...
tokens (16x):
       ...
       NUMBER_DEC IDENT PUNC_PAREN_OPEN PUNC_PAREN_CLOSE
       PUNC_CURLY_OPEN PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE PUNC_SEMI
`````
