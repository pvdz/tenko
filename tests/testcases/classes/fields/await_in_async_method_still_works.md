...
- Path: tests/testcases/classes/fields/await_in_async_method_still_works.md

> :: classes : fields
>
> ::> await in async method still works
>
> await in async method still works as AwaitExpression (not affected by field init fix)
...
tokens (14x):
       ...
       PUNC_PAREN_CLOSE PUNC_CURLY_OPEN ID_await NUMBER_DEC PUNC_SEMI
