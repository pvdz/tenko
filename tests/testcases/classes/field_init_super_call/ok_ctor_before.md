...
- Path: tests/testcases/classes/field_init_super_call/ok_ctor_before.md

> :: classes : field init super call
>
> ::> ok ctor before
>
> the same when declared before the field
...
`````js
class A extends B { constructor(){ super() } x = 1 }
`````
...
tokens (19x):
       ...
       PUNC_PAREN_OPEN PUNC_PAREN_CLOSE ASI PUNC_CURLY_CLOSE IDENT
       PUNC_EQ NUMBER_DEC PUNC_CURLY_CLOSE
`````
