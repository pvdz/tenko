...
- Path: tests/testcases/classes/class_members_do_not_have_initializers/private_ident_binding_fail.md

> :: classes : class members do not have initializers
>
> ::> private ident binding fail
>
> Private identifiers are not allowed as bindings (params, catch, var/let/const).
