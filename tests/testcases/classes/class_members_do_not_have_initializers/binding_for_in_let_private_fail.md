...
- Path: tests/testcases/classes/class_members_do_not_have_initializers/binding_for_in_let_private_fail.md

> :: classes : class members do not have initializers
>
> ::> binding for in let private fail
>
> Private identifiers are not allowed as for-in binding (let #x in obj).
