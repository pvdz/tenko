...
- Path: tests/testcases/classes/private_delete_optional_chain/delete_optional_public.md

> :: classes : private delete optional chain
>
> ::> delete optional public
>
> deleting a public prop through a chain is fine
...
tokens (18x):
       ...
       ID_delete IDENT QMARK_DOT IDENT ASI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
