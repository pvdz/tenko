...
- Path: tests/testcases/classes/private_delete_optional_chain/typeof_optional_private.md

> :: classes : private delete optional chain
>
> ::> typeof optional private
>
> typeof of a private access through a chain is fine
...
tokens (18x):
       ...
       ID_typeof IDENT QMARK_DOT ID_PRIVATE_IDENT ASI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
