...
- Path: tests/testcases/classes/private_delete_optional_chain/delete_private_tail_computed.md

> :: classes : private delete optional chain
>
> ::> delete private tail computed
>
...
tokens (21x):
       ...
       ID_delete IDENT QMARK_DOT ID_PRIVATE_IDENT PUNC_BRACKET_OPEN
       IDENT PUNC_BRACKET_CLOSE ASI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
`````
