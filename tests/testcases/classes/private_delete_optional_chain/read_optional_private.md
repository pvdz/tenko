...
- Path: tests/testcases/classes/private_delete_optional_chain/read_optional_private.md

> :: classes : private delete optional chain
>
> ::> read optional private
>
> reading a private field through a chain is fine
...
tokens (17x):
       ...
       QMARK_DOT ID_PRIVATE_IDENT ASI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
