...
- Path: tests/testcases/classes/field_init_await/ok_async_method.md

> :: classes : field init await
>
> ::> ok async method
>
> the same for an async object method
...
tokens (20x):
       ...
       PUNC_CURLY_OPEN ID_async IDENT PUNC_PAREN_OPEN PUNC_PAREN_CLOSE
