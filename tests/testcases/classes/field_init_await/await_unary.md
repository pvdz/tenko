...
- Path: tests/testcases/classes/field_init_await/await_unary.md

> :: classes : field init await
>
> ::> await unary
>
> in script goal this is the identifier `await` minus one, so only module code rejects it
...
tokens (10x):
       ID_class IDENT PUNC_CURLY_OPEN IDENT PUNC_EQ ID_await PUNC_MIN
