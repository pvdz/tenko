...
- Path: tests/testcases/classes/static_block/version_gate/var_vs_outer_let_es13.md

> :: classes : static block : version gate
>
> ::> var vs outer let es13
>
> the block var scope applies from es2022 on
...
tokens (14x):
       ID_let IDENT PUNC_SEMI ID_class IDENT PUNC_CURLY_OPEN ID_static
