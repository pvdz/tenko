...
- Path: tests/testcases/classes/static_block/function_decls/func_vs_outer_let_before.md

> :: classes : static block : function decls
>
> ::> func vs outer let before
>
> nor does it clash with an outer let
...
`````js
let f; class C { static { function f(){} } }
`````
