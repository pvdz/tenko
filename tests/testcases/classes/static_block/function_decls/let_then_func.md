...
- Path: tests/testcases/classes/static_block/function_decls/let_then_func.md

> :: classes : static block : function decls
>
> ::> let then func
>
> a let and a function declaration with the same name clash
...
╔══╦═════════════════
 1 ║ class C { static { let f; function f(){} } }
   ║                                    ^------- error
╚══╩═════════════════
