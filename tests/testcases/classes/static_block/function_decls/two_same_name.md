...
- Path: tests/testcases/classes/static_block/function_decls/two_same_name.md

> :: classes : static block : function decls
>
> ::> two same name
>
> two function declarations with the same name are var scoped so they may repeat
