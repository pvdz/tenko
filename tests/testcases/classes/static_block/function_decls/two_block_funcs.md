...
- Path: tests/testcases/classes/static_block/function_decls/two_block_funcs.md

> :: classes : static block : function decls
>
> ::> two block funcs
>
> two functions in separate blocks do not clash
...
tokens (24x):
       ...
       PUNC_CURLY_CLOSE PUNC_CURLY_OPEN ID_function IDENT
