...
- Path: tests/testcases/classes/static_block/function_decls/func_vs_outer_let_after.md

> :: classes : static block : function decls
>
> ::> func vs outer let after
>
> the same when the let follows the class
...
tokens (17x):
       ...
       PUNC_CURLY_CLOSE ID_let IDENT PUNC_SEMI
`````
