...
- Path: tests/testcases/classes/static_block/var_scope/var_vs_func_let_after.md

> :: classes : static block : var scope
>
> ::> var vs func let after
>
> the same when the let follows the class in a function
