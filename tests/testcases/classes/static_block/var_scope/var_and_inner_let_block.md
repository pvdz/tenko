...
- Path: tests/testcases/classes/static_block/var_scope/var_and_inner_let_block.md

> :: classes : static block : var scope
>
> ::> var and inner let block
>
> a let in a nested block does not clash with the block var
