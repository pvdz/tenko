...
- Path: tests/testcases/classes/static_block/var_scope/var_vs_func_let_before.md

> :: classes : static block : var scope
>
> ::> var vs func let before
>
> the same inside a function body
...
`````js
function f(){ let x; class C { static { var x; } } }
`````
