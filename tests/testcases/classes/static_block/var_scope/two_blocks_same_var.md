...
- Path: tests/testcases/classes/static_block/var_scope/two_blocks_same_var.md

> :: classes : static block : var scope
>
> ::> two blocks same var
>
> two static blocks each have their own var scope
...
tokens (17x):
       ...
       ID_var IDENT PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
`````
