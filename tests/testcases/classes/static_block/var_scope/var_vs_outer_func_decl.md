...
- Path: tests/testcases/classes/static_block/var_scope/var_vs_outer_func_decl.md

> :: classes : static block : var scope
>
> ::> var vs outer func decl
>
> an outer function declaration is unaffected
...
`````js
class C { static { var x; } } function x(){}
`````
...
tokens (17x):
       ...
       IDENT PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE ID_function
