...
- Path: tests/testcases/classes/static_block/var_scope/var_vs_outer_var.md

> :: classes : static block : var scope
>
> ::> var vs outer var
>
> an outer var is unaffected too
...
tokens (14x):
       ...
       IDENT PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE ID_var IDENT
       PUNC_SEMI
`````
