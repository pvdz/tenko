...
- Path: tests/testcases/classes/static_block/var_scope/var_in_nested_function.md

> :: classes : static block : var scope
>
> ::> var in nested function
>
> a var in a nested function does not clash with the block var
...
`````js
class C { static { function f(){ var x; } var x; } }
`````
...
tokens (20x):
       ...
       PUNC_CURLY_OPEN ID_var IDENT PUNC_SEMI PUNC_CURLY_CLOSE ID_var
...
````js
class C{static {function f() {var x;}
var x;}}
````
