...
- Path: tests/testcases/classes/static_block/var_scope/var_vs_func_var.md
...
`````js
function f(){ class C { static { var x; } } var x; }
`````
...
tokens (20x):
       ...
       PUNC_CURLY_CLOSE ID_var IDENT PUNC_SEMI PUNC_CURLY_CLOSE
`````
