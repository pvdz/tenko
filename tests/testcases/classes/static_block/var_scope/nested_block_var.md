...
- Path: tests/testcases/classes/static_block/var_scope/nested_block_var.md

> :: classes : static block : var scope
>
> ::> nested block var
>
> a var in a nested static block stays in that block
...
`````js
class C { static { class D { static { var x; } } let x; } }
`````
  ...
  body: [
    {
      ...
      body: {
        ...
        body: [
          {
            type: 'StaticBlock',
            loc:{start:{line:1,column:17},end:{line:1,column:57},source:''},
            body: [
              {
                type: 'ClassDeclaration',
