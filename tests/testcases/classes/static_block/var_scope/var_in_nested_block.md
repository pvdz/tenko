...
- Path: tests/testcases/classes/static_block/var_scope/var_in_nested_block.md

> :: classes : static block : var scope
>
> ::> var in nested block
>
> a var in a nested block is the same var scope
...
tokens (16x):
       ...
       IDENT PUNC_SEMI PUNC_CURLY_OPEN ID_var IDENT PUNC_SEMI
