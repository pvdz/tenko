...
- Path: tests/testcases/classes/static_block/var_scope/two_blocks_var_then_let.md

> :: classes : static block : var scope
>
> ::> two blocks var then let
>
> a var in one block does not clash with a let in the next
...
`````js
class C { static { var x; } static { let x; } }
`````
...
tokens (17x):
       ...
       IDENT PUNC_SEMI PUNC_CURLY_CLOSE ID_static PUNC_CURLY_OPEN
       ID_let IDENT PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
`````
