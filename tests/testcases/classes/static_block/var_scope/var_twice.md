...
- Path: tests/testcases/classes/static_block/var_scope/var_twice.md

> :: classes : static block : var scope
>
> ::> var twice
>
> duplicate vars are fine inside the block
...
tokens (14x):
       ...
       IDENT PUNC_SEMI ID_var IDENT PUNC_SEMI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
