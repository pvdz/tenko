...
- Path: tests/testcases/classes/static_block/arguments/as_class_field_key.md

> :: classes : static block : arguments
>
> ::> as class field key
>
> the same for a class field name
...
`````js
class C { static { class D { arguments; } } }
`````
...
tokens (14x):
       ...
       ID_class IDENT PUNC_CURLY_OPEN ID_arguments PUNC_SEMI
