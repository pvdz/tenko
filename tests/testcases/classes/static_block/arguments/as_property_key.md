...
- Path: tests/testcases/classes/static_block/arguments/as_property_key.md

> :: classes : static block : arguments
>
> ::> as property key
>
> a property named `arguments` is not an IdentifierReference so it is fine
...
tokens (16x):
       ...
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_arguments PUNC_COLON
       NUMBER_DEC PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE PUNC_SEMI
