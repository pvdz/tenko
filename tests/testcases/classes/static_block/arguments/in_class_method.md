...
- Path: tests/testcases/classes/static_block/arguments/in_class_method.md
...
`````js
class C { static { class D { m(){ arguments; } } }; }
`````
...
tokens (20x):
       ...
       PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE PUNC_SEMI
       PUNC_CURLY_CLOSE
`````
