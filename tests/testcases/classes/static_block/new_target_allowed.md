...
- Path: tests/testcases/classes/static_block/new_target_allowed.md

> :: classes : static block
>
> ::> new target allowed
>
> new.target is allowed in static block
...
tokens (12x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static PUNC_CURLY_OPEN ID_new
       PUNC_DOT ID_target PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
`````
