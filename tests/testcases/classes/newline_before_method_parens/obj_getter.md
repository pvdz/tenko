...
- Path: tests/testcases/classes/newline_before_method_parens/obj_getter.md

> :: classes : newline before method parens
>
> ::> obj getter
>
> the same for a getter
...
tokens (14x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_get PUNC_BRACKET_OPEN IDENT
