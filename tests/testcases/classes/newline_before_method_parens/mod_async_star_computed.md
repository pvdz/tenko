...
- Path: tests/testcases/classes/newline_before_method_parens/mod_async_star_computed.md

> :: classes : newline before method parens
>
> ::> mod async star computed
>
> a newline before `(` after a async_star computed key
