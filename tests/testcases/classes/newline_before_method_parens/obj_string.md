...
- Path: tests/testcases/classes/newline_before_method_parens/obj_string.md

> :: classes : newline before method parens
>
> ::> obj string
>
> the same for a string key
...
tokens (11x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN STRING_DOUBLE PUNC_PAREN_OPEN
