...
- Path: tests/testcases/classes/newline_before_method_parens/field_then_method.md

> :: classes : newline before method parens
>
> ::> field then method
>
> a computed field then a method
...
tokens (13x):
       ...
       PUNC_BRACKET_CLOSE IDENT PUNC_PAREN_OPEN PUNC_PAREN_CLOSE
