...
- Path: tests/testcases/import_attributes/dynamic_import_trailing_comma.md

> :: import attributes
>
> ::> dynamic import trailing comma
>
> Dynamic import with trailing comma after second argument.
...
tokens (17x):
       ...
       PUNC_COLON STRING_SINGLE PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
       PUNC_COMMA PUNC_PAREN_CLOSE ASI
`````
