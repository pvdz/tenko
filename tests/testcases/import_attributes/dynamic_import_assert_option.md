...
- Path: tests/testcases/import_attributes/dynamic_import_assert_option.md

> :: import attributes
>
> ::> dynamic import assert option
>
> `assert` as property name in options object is syntactically valid (just a normal object literal). Not a parser concern.
...
tokens (16x):
       ...
       PUNC_CURLY_OPEN IDENT PUNC_COLON PUNC_CURLY_OPEN IDENT
