...
- Path: tests/testcases/assigns/to_keyword/should_listen_to_use_strict_directive_in_getter_5bimport5d.md

> :: assigns : to keyword
>
> ::> should listen to use strict directive in getter 5bimport5d
