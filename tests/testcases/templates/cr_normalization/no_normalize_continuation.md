...
- Path: tests/testcases/templates/cr_normalization/no_normalize_continuation.md

> :: templates : cr normalization
>
> ::> no normalize continuation
>
> the same for a line continuation with a CR
