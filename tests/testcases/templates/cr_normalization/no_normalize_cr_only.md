...
- Path: tests/testcases/templates/cr_normalization/no_normalize_cr_only.md

> :: templates : cr normalization
>
> ::> no normalize cr only
>
> with raw normalization off the printer reproduces a CR only template losslessly
