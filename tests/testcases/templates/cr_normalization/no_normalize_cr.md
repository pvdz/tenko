...
- Path: tests/testcases/templates/cr_normalization/no_normalize_cr.md

> :: templates : cr normalization
>
> ::> no normalize cr
>
> with raw normalization off the raw value keeps the CR but the cooked value still normalizes
