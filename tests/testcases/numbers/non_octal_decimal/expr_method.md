...
- Path: tests/testcases/numbers/non_octal_decimal/expr_method.md

> :: numbers : non octal decimal
>
> ::> expr method
>
> a method call on the fraction form
...
tokens (10x):
       IDENT PUNC_EQ NUMBER_OLD PUNC_DOT IDENT PUNC_PAREN_OPEN
