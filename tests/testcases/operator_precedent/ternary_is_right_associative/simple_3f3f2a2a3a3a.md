...
- Path: tests/testcases/operator_precedent/ternary_is_right_associative/simple_3f3f2a2a3a3a.md
...
tokens (13x):
       IDENT PUNC_QMARK IDENT PUNC_QMARK IDENT PUNC_STAR_STAR IDENT
