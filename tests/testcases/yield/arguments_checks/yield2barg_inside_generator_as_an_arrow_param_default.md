...
- Path: tests/testcases/yield/arguments_checks/yield2barg_inside_generator_as_an_arrow_param_default.md

> :: yield : arguments checks
>
> ::> yield2barg inside generator as an arrow param default
