...
- Path: tests/testcases/yield/yield_in_group_in_param_default/group_yield2barg_piggy_test_in_func_param_default_2.md

> :: yield : yield in group in param default
>
> ::> group yield2barg piggy test in func param default 2
>
