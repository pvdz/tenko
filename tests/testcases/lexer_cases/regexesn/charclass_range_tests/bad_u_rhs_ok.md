...
- Path: tests/testcases/lexer_cases/regexesn/charclass_range_tests/bad_u_rhs_ok.md
...
>
> The `\u-` is a bad escape and in sloppy mode adds the codepoint for `u` to the char class. So it's basically `s-u`, which is bad (s<u).
