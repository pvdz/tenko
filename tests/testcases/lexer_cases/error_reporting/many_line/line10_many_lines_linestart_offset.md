...
- Path: tests/testcases/lexer_cases/error_reporting/many_line/line10_many_lines_linestart_offset.md

> :: lexer cases : error reporting : many line
>
> ::> line10 many lines linestart offset
>
...
>
> In this test the code frame will start exactly at the end of line 4, immediately before the newline to line 5. A problem was causing a off-by-one error for this case.
