...
- Path: tests/testcases/functions/yield_await/normal_async/name/obj_method/obj_method_can_be_called_yield.md

> :: functions : yield await : normal async : name : obj method
>
