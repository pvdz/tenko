...
- Path: tests/testcases/functions/yield_await/normal_async/arg-name/func_decl/generator_func_decl_arg_called_await.md
...
╔══╦═════════════════
 1 ║ async function as(){ function *f(await) {} }
   ║                                  ^^^^^------- error
╚══╩═════════════════
