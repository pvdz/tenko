...
- Path: tests/testcases/functions/yield_await/generator/name/func_decl/async_generator_func_decl_can_be_called_await.md
...
╔══╦═════════════════
 1 ║ function *as(){ async function *await() {} }
   ║                                 ^^^^^------- error
╚══╩═════════════════
