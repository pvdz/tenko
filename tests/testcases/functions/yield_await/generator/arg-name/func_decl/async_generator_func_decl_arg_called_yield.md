...
- Path: tests/testcases/functions/yield_await/generator/arg-name/func_decl/async_generator_func_decl_arg_called_yield.md
...
╔══╦═════════════════
 1 ║ function *as(){ async function *f(yield) {} }
   ║                                   ^^^^^------- error
╚══╩═════════════════
