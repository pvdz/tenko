...
- Path: tests/testcases/functions/declaration/block_scoped/gen/catch_block/function28297b7d.md
...
╔══╦═════════════════
 1 ║ try { } catch (e) { function(){} function(){} }
   ║                             ^------- error
╚══╩═════════════════
