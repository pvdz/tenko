...
- Path: tests/testcases/functions/declaration/block_scoped/block_func_and_var_sibling_blocks_pass.md

> :: functions : declaration : block scoped
>
> ::> block func and var sibling blocks pass
>
> A block function and var in sibling blocks do not conflict because they are in different scope levels.
...
tokens (20x):
       ...
       PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE PUNC_CURLY_OPEN ID_var IDENT
