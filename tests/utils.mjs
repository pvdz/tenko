...
function parseTestFile(tob) {
  ...
  const {es, astUids, locationTracking, ranges, nodeRange, exposeScopes, alwaysAllowOctalEscapes, allowUsingDeclaration, templateNewlineNormalization, ...unsupported} = tob.inputOptions
